...
//
// circuit https://i.imgur.com/cGPNipD.jpg
// IR : https://i.imgur.com/Y2n29ZZ.jpg
import UIKit
...
class ViewController: UIViewController {
    ...
    @IBAction func postRequest(_ sender: Any) {
        ...
        guard let mediaImage = Media(withImage:UIImage(named:"daksh")!, forKey: "image") else { return }
